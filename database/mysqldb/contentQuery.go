...
const (
	...
	UpdateContentQuery      = "UPDATE content set title = ?, category = ?, modified_date = ?, meta_author_name = ?, meta_desc = ?,meta_key_words = ?, meta_robot_key_words = ?, text = ? where id = ? and client_id = ? "
